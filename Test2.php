...
<form action="TestController.php" method="POST" enctype="multipart/form-data">
	...
	<textarea  name="ques1" placeholder="For family car what’s better to use leaf spring or coil spring and damper?" required="required" rows="9" cols="25" style="margin-right:20px;"></textarea>
   <textarea  name="ques2" placeholder="Could we put leaf spring with coil spring a onr car and be effective " required="required" rows="9" cols="25" style="margin-right:20px;"></textarea>
